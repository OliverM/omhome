...
Two middleware functions by default which are are located in the `omhome.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `omhome.handler` namespace to manage the enabled middleware.
